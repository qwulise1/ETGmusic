...
ETGmusic is now rebuilt on top of the open-source Spotube codebase instead of
the previous native Java prototype.

This product includes software developed by Kingkor Roy Tirtho. Spotube is
licensed under BSD-4-Clause; the original license is kept in [LICENSE](LICENSE).
