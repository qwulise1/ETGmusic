...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get u_love_etgmusic => 'Chúng tôi biết bạn yêu ETGmusic';

  @override
  String get check_for_updates => 'Kiểm tra cập nhật';

  @override
  String get about_etgmusic => 'Về ETGmusic';
  ...
  String get etgmusic_description =>
      'ETGmusic, một ứng dụng Spotify nhẹ, đa nền tảng và miễn phí';
  ...
  String get download_ip_ban_warning =>
      'Địa chỉ IP của bạn có thể bị chặn trên YouTube do yêu cầu tải xuống quá mức so với bình thường. Chặn IP có nghĩa là bạn không thể sử dụng YouTube (ngay cả khi bạn đã đăng nhập) ít nhất 2-3 tháng từ thiết bị IP đó. Và ETGmusic không chịu trách nhiệm nếu điều này xảy ra';
  ...
  String get download_agreement_3 =>
      'Tôi hoàn toàn nhận thức được rằng địa chỉ IP của tôi có thể bị chặn trên YouTube và tôi không đổ lỗi cho ETGmusic hoặc chủ sở hữu/người đóng góp của nó về bất kỳ tai nạn nào do hành động này của tôi';
  ...
  String get encryption_failed_warning =>
      'ETGmusic không thành công trong việc mã hóa nhằm lưu trữ dữ liêu an toàn. vậy nên sẽ chuyển về lưu trữ không an toàn\nNếu bạn đang sử dụng Linux, đảm bảo rằng bạn có sử dụng dịch vụ bảo mật (gnome-keyring, kde-wallet, keepassxc, v.v.)';
  ...
  String get choose_your_region_description =>
      'Điều này sẽ giúp ETGmusic hiển thị nội dung phù hợp cho vị trí của bạn.';
  ...
  String get help_project_grow_description =>
      'ETGmusic là một dự án mã nguồn mở. Bạn có thể giúp dự án này phát triển bằng cách đóng góp vào dự án, báo cáo lỗi hoặc đề xuất tính năng mới.';
  ...
  String get enable_connect_description =>
      'Điều khiển ETGmusic từ các thiết bị khác';
  ...
  @override
  String get etgmusic_has_an_update => 'ETGmusic có bản cập nhật';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'ETGmusic Nightly $nightlyBuildNum đã được phát hành';
  }

  @override
  String release_version(Object version) {
    return 'ETGmusic v$version đã được phát hành';
  }
