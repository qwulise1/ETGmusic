...
abstract class AppLocalizations {
  ...
  /// No description provided for @u_love_etgmusic.
  ///
  /// In en, this message translates to:
  /// **'We know you love ETGmusic'**
  ...
  /// No description provided for @about_etgmusic.
  ///
  /// In en, this message translates to:
  /// **'About ETGmusic'**
  String get about_etgmusic;
  ...
  /// No description provided for @etgmusic_description.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Control ETGmusic from other devices'**
  ...
  /// No description provided for @etgmusic_has_an_update.
  ///
  /// In en, this message translates to:
  /// **'ETGmusic has an update'**
  String get etgmusic_has_an_update;
  ...
  ///
  /// In en, this message translates to:
  /// **'ETGmusic Nightly {nightlyBuildNum} has been released'**
  String nightly_version(Object nightlyBuildNum);

  /// No description provided for @release_version.
  ///
  /// In en, this message translates to:
  /// **'ETGmusic v{version} has been released'**
