...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get u_love_etgmusic => 'ETGmusic\'u sevdiğinizi biliyoruz';

  @override
  String get check_for_updates => 'Güncellemeleri kontrol et';

  @override
  String get about_etgmusic => 'ETGmusic hakkında';
  ...
  String get etgmusic_description =>
      'ETGmusic, hafif, platformlar arası uyumlu ve herkes için ücretsiz bir Spotify istemcisidir.';
  ...
  String get download_ip_ban_warning =>
      'Ayrıca, normalden fazla indirme istekleri nedeniyle YouTube\'da IP\'niz engellenebilir. IP engeli, en az 2-3 ay boyunca YouTube\'u (hatta oturum açmış olsanız bile) o IP cihazından kullanamayacağınız anlamına gelir. Ve eğer böyle bir durum yaşanırsa, ETGmusic bundan hiçbir sorumluluk kabul etmez.';
  ...
  String get download_agreement_3 =>
      'YouTube\'da IP\'min engellenebileceğinin tamamen farkındayım ve mevcut eylemlerimden kaynaklanan herhangi bir kaza için ETGmusic\'u veya sahiplerini/katkıda bulunanları sorumlu tutmuyorum.';
  ...
  String get encryption_failed_warning =>
      'ETGmusic, verilerinizi güvenli bir şekilde depolamak için şifreleme kullanır. Ancak bunu başaramadı. Bu nedenle, güvensiz depolamaya geri dönecektir\nLinux kullanıyorsanız, lütfen gnome-keyring, kde-wallet, keepassxc vb. herhangi bir gizli servisin yüklü olduğundan emin olun.';
  ...
  String get choose_your_region_description =>
      'Bu, ETGmusic\'un konumunuza uygun içerikleri göstermesine yardımcı olacaktır.';
  ...
  String get help_project_grow_description =>
      'ETGmusic açık kaynaklı bir projedir. Projeye katkıda bulunarak, hataları bildirerek veya yeni özellikler önererek bu projenin büyümesine yardımcı olabilirsiniz.';
  ...
  String get enable_connect_description =>
      'ETGmusic\'u diğer cihazlardan kontrol edin';
  ...
  @override
  String get etgmusic_has_an_update => 'ETGmusic bir güncelleme aldı';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'ETGmusic Nightly $nightlyBuildNum yayımlandı';
  }

  @override
  String release_version(Object version) {
    return 'ETGmusic v$version yayımlandı';
  }
